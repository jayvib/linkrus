...
type Graph interface {
	...
	// UpsertEdge insert a new link or updates an existing edge.
...
type Iterator interface {
	// Next advances the iterator. If no more items are available
	// or an error occurs, calls to Next() return false
	Next() bool
...
// EdgeIterator is implemented by objects that can iterate graph edges.
